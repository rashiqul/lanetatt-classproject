...
echo "   poetry run python src/train.py --config configs/tusimple_debug.yaml --wandb"
echo ""
echo "2. Run full training:"
echo "   poetry run python src/train.py --config configs/tusimple_full.yaml --wandb"
echo ""
